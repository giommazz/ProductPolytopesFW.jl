...
```bash
git clone --recurse-submodules git@github.com:giommazz/product-polytopes-fw.git
```
...
1. Clone this repository and navigate to the `code/ProductPolytopesFW` directory.
2. Start Julia and activate the local environment
```bash
cd product-polytopes-fw/code/ProductPolytopesFW
julia --project=. 
```
