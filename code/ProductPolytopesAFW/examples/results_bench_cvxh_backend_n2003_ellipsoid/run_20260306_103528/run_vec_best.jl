...
config = Config("examples/results_bench_cvxh_backend_n2003_ellipsoid/run_20260306_103528/config_vec_best.yml")
print_config(config)
...
# ---------------------------------------------------------------------------------
# PARAMETERS
results_dir = "examples/results_bench_cvxh_backend_n2003_ellipsoid/run_20260306_103528/vec_best" # "results_shortstep",
