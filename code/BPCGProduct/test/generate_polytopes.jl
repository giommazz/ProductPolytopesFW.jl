...
filename = save_intersecting_polytopes(config, vertices, polytopes, intersecting_polytopes_polyhedra, intersecting_polytopes_jump)
...
verticesj, polytopesj, intersecting_polytopes_polyhedraj, intersecting_polytopes_jumpj = 
    load_intersecting_polytopes(filename)
